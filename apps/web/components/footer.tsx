...
export default function Footer() {
  return (
    <footer className="relative mt-12 overflow-hidden border-t border-white/5 bg-gradient-to-b from-[#06221a] to-[#02140f] text-green-100/90">
      ...
      <div className="absolute top-0 right-0 left-0 h-[1px] bg-gradient-to-r from-transparent via-green-400/30 to-transparent" />
        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-3 lg:gap-8">
          ...
          <div className="order-2 flex flex-col items-center">
            <div className="mb-4 flex items-center gap-3">
              <div className="h-[1px] w-6 bg-gradient-to-r from-transparent to-green-500/30" />
              <div className="h-1.5 w-1.5 rounded-full border border-green-500/30" />
              <div className="h-[1px] w-6 bg-gradient-to-l from-transparent to-green-500/30" />
            </div>
          ...
          <div className="order-3 flex flex-col items-center gap-4 lg:items-end">
            <div className="w-full max-w-[280px] space-y-3">
              <div className="group flex items-center gap-4 rounded-xl border border-transparent p-3 transition-all duration-500 hover:bg-white/[0.02]">
              ...
              <a
                ...
                className="group flex items-center gap-4 rounded-xl border border-transparent p-3 transition-all duration-500 hover:bg-white/[0.02]"
              >
                <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-green-500/20 bg-green-500/10">
