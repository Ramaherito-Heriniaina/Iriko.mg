...
export const mg: Dictionary = {
  ...
  preCommande: {
    hero: {
      badge: "Vokatra 100% Natoraly",
      title: "Legioma Miavaka",
      subtitle: "NATORALY",
      quote: "Avy amin'ny tany mankany amin'ny latabatrao, fehezo ny famokarana amin'ny alalan'ny fisafidianana ny fomba fambolena tianao.",
      btnDiscover: "Hijery LEMA",
      btnView: "Hijery ny vokatra",
      qualityBadge: "AZO ANTOKA"
    },
    modal: {
      title: "Momba ny LEMA",
      slogan: "Fambolena manara-penitra eo am-pelatananao.",
      description: "LEMA dia sehatra vaovao ahafahan'ny tsirairay ho lasa mpamokatra na dia lavidavitra aza. Ampifandraisinay ny teknolojia sy ny fambolena natoraly mba hanomezana anao fifehezana tanteraka ny fambolenao.",
      points: {
        transparency: "Mangarahara: Araho ny fitomboan'ny legiomanao amin'ny fotoana rehetra.",
        ethics: "Fitsipika: Fomba fambolena natoraly 100% sy manaja ny tontolo iainana.",
        local: "An-toerana: Tohano ny tantsaha malagasy sady miantoka ny sakafonao."
      },
      btnClose: "Azo saina"
    },
    features: [
      { title: "Fanaterana", desc: "Manerana an'i Madagasikara", icon: "🚚" },
      { title: "Fandoavana azo antoka", desc: "50% mialoha", icon: "🛡️" },
      { title: "Antoka famerenam-bola", desc: "Raha misy fahasimbana", icon: "💰" },
      { title: "Fanarahana mivantana", desc: "Avy eny an-tsaha", icon: "⚡" }
    ],
    card: {
      btn_order: "HAFATRA MIALOHA",
      unit_per_kg: "/ kg"
    },
    orderFlow: {
      steps: {
        selection: 'Fikirakirana',
        proforma: 'Faktiorako',
        payment: 'Fandoavana',
        labelSelection: 'Safidy',
        labelProforma: 'Famintinana',
        labelPayment: 'Antoka'
      }
    },
    footer: {
      whyChooseUs: {
        ...
        features: {
          ...
          orderFlow: {
            ...
            footerTagline: 'Iriko Fambolena Maharitra'
          },

          payment: {
            title: "Misaotra tamin'ny fividianana!",
            confirmation_sent: "Nalefa mailaka fanamafisana any amin'ny",
            client_ref: "Laharana mpanjifa",
            deposit_paid: "Antoka voaray",
            balance_due: "Sisa aloasana",
            download_receipt: "Haka ny rosia",
            back_home: "Hiverina amin'ny fandraisana",
            deposit_label: "Antoka aloa (50%)",
            total_purchase: "Vidin'ny rehetra",
            secure_payment: "Fandoavana azo antoka",
            choose_method: "Fidio ny fomba fandoavanao",
            account_label: "Kaonty",
            ussd_code: "Kaody USSD",
            scan_qr: "Skanina QR",
            btn_transfer_done: "Efa nalefako ny vola",
            validation_title: "Fanamarinana & Mombamomba",
            placeholder_name: "Anarana",
            placeholder_firstname: "Fanampiny",
            placeholder_email: "Mailaka (ho an'ny rosia PDF)",
            paceholder_numero: "Laharana finday",
            transaction_id_label: "Laharana fifanakalozana (SMS)",
            btn_confirm: "Hamarina & Handray ny rosia"
          },

          proforma: {
            invoice_label: "Faktiora Proforma",
            volume_label: "Habetsaky ny baiko",
            engrais_label: "Karazana zezika",
            production_site: "Toerana famokarana",
            unit_price: "Vidin'ny iray",
            total_to_pay: "Vola rehetra aloa",
            validity_note: "Ity faktiora ity dia manan-kery mandritra ny 48 ora. Mila mandoa 50% ho antoka hanombohana ny famokarana.",
            btn_back: "Hiverina",
            btn_confirm: "Hamarina"
          },
          ...
          selection: {
            ...
            unit_kg: "KG",
            net_weight: "Lanja",
            min_error: "⚠ Farafahakeliny : 5 kg",
            fertilizer_label: "Safidy zezika",
            fertilizer_sub: "Zezika Premium",
            origin_label: "Toerana niaviana",
            btn_generate: "Hamoaka faktiora",
            btn_incomplete: "Fenoy ny safidy"
          }
        },
        products: {
          title2: 'Ny vokatray',
          category: {
            ...
            bredes: 'Anana',
            legumes: 'Legioma',
            tubercules: 'Vokatra an-tany'
          },
          name: {
            haricot_vert: 'Tsaramaso Maitso',
            haricot_rouge: 'Tsaramaso Mena',
            haricot_blanc: 'Tsaramaso Fotsy',
            kabaro: 'Kabaro',
            katsaka: 'Katsaka',
            ...
            anatsonga: 'Anatsonga',
            tomate: 'Domatô',
            aubergine: 'Bery lazany',
            poivron: 'Poivron',
            concombre: 'Kokombra',
            carotte: 'Karioty',
            pdt: 'Ovy',
            patate_douce: 'Bambon-tany'
          }
        }
      },
      brand: {
